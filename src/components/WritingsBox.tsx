...
const WritingsBox: React.FC<BlogBoxProps> = ({ img, head, des, link }) => {
  return (
    <a href={link} target="_blank" className="blog-post flex md:flex-row flex-col items-center gap-3">
      <Image className="md:w-[20%] w-full object-cover h-[100px] select-none rounded-md"
        src={img} alt="Blog Image" width={200} height={200} />
