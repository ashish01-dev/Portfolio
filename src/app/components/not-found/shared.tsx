...
type ActionsProps = Pick<NotFoundProps, "homeHref" | "homeLabel" | "browseHref" | "browseLabel" | "className">;
...
export function NotFoundStage({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <div className={cn("flex min-h-[420px] w-full flex-col items-center justify-center gap-8 px-4 text-center", className)}>
      {children}
    </div>
  );
}
